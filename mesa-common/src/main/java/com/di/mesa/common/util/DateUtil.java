...
public class DateUtil {
	...
	public static final String FORMAT_DATE_TIME_IN_MINUTES = "yyyy-MM-dd HH:mm";
	 ...
	 * @return
	 */
	public static long getCurTimestampInMinutes() {
	...
	public static void main(String args[]) {
		Date date = new Date(1404788885786l);
		// String strDate = StrDate(FORMAT_DATETIMES, date);
		// System.out.println(strDate);
		// System.out.println(System.currentTimeMillis());

		System.out.println("StrDate-->" + StrDate(FORMAT_DATE, date));
		System.out.println("getYearStr-->" + getYearStr(date));
		System.out.println("getMonthStr-->" + getMonthStr(date));
		System.out.println(getTimesmorning("2014/07/22"));
		System.out.println(new Timestamp(getTimesmorning("2014/07/22")));
		
		
		
		System.out.println("getCurDateStr-->"+getCurDateStr());
		System.out.println("getCurDateTimeStr-->"+getCurDateTimeStr());
		System.out.println("getCurrentBidInternal-->"+getCurrentBidInternal());
		System.out.println("getCurrentDateStr-->"+getCurrentDateStr());
		System.out.println("getCurScribeDateStr-->"+getCurScribeDateStr());
		
		System.out.println("getCurTimestampInMinutes->"+getCurTimestampInMinutes());
		System.out.println("getCurTimestampInMinutes->"+new Date(getCurTimestampInMinutes()));

		System.out.println("getCurTimestamp->"+getCurTimestamp());
		System.out.println("getCurTimestamp->"+new Date(getCurTimestamp()));
	...
	public static long getTimesmorning(String dateStr) {
		Date date = StrUtil.string2Date("yyyy/MM/dd", dateStr);
		return date.getTime();
	}
