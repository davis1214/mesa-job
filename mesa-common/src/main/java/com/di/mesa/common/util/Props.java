...
import com.di.mesa.common.exception.UndefinedPropertyException;
...
public class Props {
	...
	/**
	 * Returns a map of all the flattened properties, the item in the returned
	...
	public Map<String, String> getMapByPrefix(String prefix) {
		Map<String, String> values = _parent == null ? new HashMap<String, String>() : _parent.getMapByPrefix(prefix);
