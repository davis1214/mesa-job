...
public class Utils {
	...
	/**
	 * @param strMemSize
	 *            : memory string in the format such as 1G, 500M, 3000K, 5000
	...
	public static long parseMemString(String strMemSize) {
		...
		long size = 0L;
		if (strMemSize.endsWith("g") || strMemSize.endsWith("G") || strMemSize.endsWith("m")
				|| strMemSize.endsWith("M") || strMemSize.endsWith("k") || strMemSize.endsWith("K")) {
