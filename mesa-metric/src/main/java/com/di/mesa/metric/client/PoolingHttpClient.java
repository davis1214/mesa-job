...
public class PoolingHttpClient {
	...
	public SimpleHttpResponse doPost(String url, String data)
		...
		requestEntity.setContentEncoding(Charset.forName("UTF-8").name());
		//requestEntity.setContentEncoding(Charset.forName("ISO-8859-1").name());
		
		
		System.out.println("--->" + requestEntity.getContentEncoding().getName() + " , "+  requestEntity.getContentEncoding().getValue());
		HttpPost postMethod = new HttpPost(url);
		postMethod.setEntity(requestEntity);
		
		//postMethod.addHeader("Content-Type","text/html;charset=ISO-8859-1");
